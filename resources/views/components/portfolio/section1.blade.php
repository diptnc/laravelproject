    ...
    <section class="section site-portfolio">
        <div class="container">
            <div class="row mb-5 align-items-center">
                ...
                <div class="col-md-12 col-lg-12 col-xl-12 text-center text-lg-center" data-aos="fade-up" data-aos-delay="100">
                    <div id="filters" class="filters">
                        <a href="#" data-filter="*" class="active">All</a>
                        <a href="#" data-filter=".featured" >Featured</a>
                        <a href="#" data-filter=".web-development-category">Web projects</a>
                        <a href="#" data-filter=".custom-development-category">Coding</a>
                        <a href="#" data-filter=".ui-ux-category">Ui/Ux</a>
                        <a href="#" data-filter=".graphics-design-category">Graphics Design</a>
