    ...
    <div class="container ">
        <div class="row">
            <div class="col-md-12">
                ...
                <p  class="text-center text-sm-left text-md-left text-lg-left text-xl-left t2">Date : {{$pp->date}}</p>
                ...
                <div class="text-center text-sm-left text-md-left text-lg-left text-xl-left ">
                    <picture>
                        <source class="lazy" srcset={{ asset("assets/images/portfolio/$pp_image_name.webp") }}
                            type="image/webp" alt="{{ $pp_image_name }}">
                        <source class="lazy" srcset={{ asset("assets/images/portfolio/$pp_image_name.$pp_image_type") }}
                            type="image/{{ $pp_image_type }}" alt="{{ $pp_image_name }}">
                        <img class="lazy" src={{ asset("assets/images/portfolio/$pp_image_name.$pp_image_type") }}
                            alt="{{ $pp_image_name }}">
            ...
            <div class="col-md-12">
                <h1 class="text-center text-sm-left text-md-left text-lg-left text-xl-left t3">{{$pp->title}}</h1>
                <p class="text-center text-sm-left text-md-left text-lg-left text-xl-left t5">{!!$pp->description!!}</p>
                <div class="text-center text-sm-left text-md-left text-lg-left text-xl-left">
