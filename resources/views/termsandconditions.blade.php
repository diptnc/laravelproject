...
<body>
    <section class="container"
        style="margin-top:15vh;text-align: justify;text-justify: inter-character; background:white;padding:5vh 10vw;">



        <h2 style="text-align: center;"><b>TERMS AND CONDITIONS</b></h2>
        <p>Last updated: 2020-12-26</p>
        <p>1. <b>Introduction</b></p>
        <p>Welcome to <b>Diptanu chakraborty</b> (“Company”, “we”, “our”, “us”)!</p>
        <p>These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at
            <b>diptanuchakraborty.in</b> (together or individually “Service”) operated by <b>Diptanu chakraborty</b>.
        </p>
        ...
        <p>If you do not agree with (or cannot comply with) Agreements, then you may not use the Service, but please let
            us know by emailing at <b>chakrabortyd943@gmail.com</b> so we can try to find a solution. These Terms apply
        ...
        <p>By using our Service, you agree to subscribe to newsletters, marketing or promotional materials and other
            ...
            by following the unsubscribe link or by emailing at chakrabortyd943@gmail.com.</p>
        <p>3. <b>Purchases</b></p>
        ...
        <p>At the end of each Billing Cycle, your Subscription will automatically renew under the exact same conditions
            unless you cancel it or Diptanu chakraborty cancels it. You may cancel your Subscription renewal either
            through your online account management page or by contacting chakrabortyd943@gmail.com customer support
            team.</p>
        <p>A valid payment method is required to process the payment for your subscription. You shall provide Diptanu
            chakraborty with accurate and complete billing information that may include but not limited to full name,
            address, state, postal or zip code, telephone number, and a valid payment method information. By submitting
            such payment information, you automatically authorize Diptanu chakraborty to charge all Subscription fees
            incurred through your account to any such payment instruments.</p>
        <p>Should automatic billing fail to occur for any reason, Diptanu chakraborty reserves the right to terminate
            your access to the Service with immediate effect.</p>
        <p>6. <b>Free Trial</b></p>
        <p>Diptanu chakraborty may, at its sole discretion, offer a Subscription with a free trial for a limited period
            of time ("Free Trial").</p>
        <p>You may be required to enter your billing information in order to sign up for Free Trial.</p>
        <p>If you do enter your billing information when signing up for Free Trial, you will not be charged by Diptanu
            chakraborty until Free Trial has expired. On the last day of Free Trial period, unless you cancelled your
        ...
        <p>At any time and without notice, Diptanu chakraborty reserves the right to (i) modify Terms of Service of Free
            Trial offer, or (ii) cancel such Free Trial offer.</p>
        <p>7. <b>Fee Changes</b></p>
        <p>Diptanu chakraborty, in its sole discretion and at any time, may modify Subscription fees for the
            Subscriptions. Any Subscription fee change will become effective at the end of the then-current Billing
            Cycle.</p>
        <p>Diptanu chakraborty will provide you with a reasonable prior notice of any change in Subscription fees to
        ...
        <p>Diptanu chakraborty has the right but not the obligation to monitor and edit all Content provided by users.
        </p>
        <p>In addition, Content found on or through this Service are the property of Diptanu chakraborty or used with
        ...
        <p>Service and its original content (excluding Content provided by users), features and functionality are and
            will remain the exclusive property of Diptanu chakraborty and its licensors. Service is protected by
            copyright, trademark, and other laws of and foreign countries. Our trademarks may not be used in connection
            with any product or service without the prior written consent of Diptanu chakraborty.</p>
        ...
        <p>If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work has
            ...
            chakrabortyd943@gmail.com, with the subject line: “Copyright Infringement” and include in your claim a
        ...
        <p>You can contact our Copyright Agent via email at chakrabortyd943@gmail.com.</p>
        <p>17. <b>Error Reporting and Feedback</b></p>
        <p>You may provide us either directly at chakrabortyd943@gmail.com or via third party sites and tools with
        ...
        <p>Our Service may contain links to third party web sites or services that are not owned or controlled by
            Diptanu chakraborty.</p>
        <p>Diptanu chakraborty has no control over, and assumes no responsibility for the content, privacy policies, or
        ...
        <p>Please send your feedback, comments, requests for technical support by email:
            <b>chakrabortyd943@gmail.com</b>.</p>
        <p style="margin-top: 5em; font-size: 0.7em;">These <a href="https://policymaker.io/terms-and-conditions/">Terms
                of Service</a> were created for <b>diptanuchakraborty.in</b> by <a
                href="https://policymaker.io">PolicyMaker.io</a> on 2020-12-26.</p>
